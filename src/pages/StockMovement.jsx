    ...
    <div className="space-y-5 pb-12">
      ...
      <div className="bg-white rounded-2xl p-5 shadow-xs border border-slate-200/80 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-3.5">
          ...
          <div>
            <h1 className="text-xl font-bold text-slate-800 tracking-tight">Stock Movement &amp; Relocation</h1>
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-200">
            ...
            <form onSubmit={handleCreateMovement} className="pt-4 space-y-3.5 text-xs">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1">
                    Origin Bin / Location <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-xs font-bold text-slate-700 mb-1">
                    Destination Bin / Bay <span className="text-rose-500">*</span>
                  </label>
                  <input
                    type="text"
                    required
                    ...
                    placeholder="e.g. SH03-R05-C08"
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl p-2 text-xs font-mono font-bold text-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white"
                  />
                </div>
              </div>
